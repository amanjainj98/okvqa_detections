...
coco_image_dir = "/mnt/data/aman/block/block.bootstrap.pytorch/data/vqa/coco/raw/val2014"
count = 0
detected_objects = {}
with open(dataset_file) as json_file:
    ...
    for i in data["questions"]:
      image_id = i["image_id"]
      n = len(str(image_id))
      image_file = "COCO_val2014_" + "0"*(12-n) + str(image_id) + ".jpg"
...
with open("detected_imagenet_objects_val.json",'w') as f:
